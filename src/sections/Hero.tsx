...
const Hero = () => {
  return (
    <section className='relative overflow-hidden py-20 pt-44 md:py-24 bg-gradient-to-b from-[#E6F7FF] to-[#FFFFFF]'>
      <div className='relative z-10 max-w-6xl mx-auto px-6'>
        <div className='flex justify-center items-center'>
          ...
          <div className='relative md:block flex flex-col justify-center items-center'>
            ...
            >
              {/* Décor */}
              <span className='absolute -bottom-6 -right-8 w-[40px] md:w-[75px] h-[38px] md:h-[70px] border-8 md:border-[14px] border-white backdrop-blur-lg' />
            ...
            <div
              className='
                ...
                bg-white/90 p-3 px-10 md:p-7 shadow-md
                transition-all duration-300
                md:hover:-translate-y-3 md:hover:shadow-xl
              '
            >
              {/* Décor */}
              <span className='absolute -top-[50px] -left-8 w-[40px] md:w-[75px] h-[38px] md:h-[70px] border-8 md:border-[14px] border-white backdrop-blur-lg' />
        ...
        <div className='-mt-10 md:mt-10 flex flex-col sm:flex-row justify-center gap-4 max-w-[300px] mx-auto'>
          ...
          <Button variant='nofill' border='primary' fullOnMobile>
            Contact me
          </Button>
        </div>
        ...
        <div className='mt-12 hidden md:flex justify-center'>
          <span className='text-sm font-semibold text-primary-600 flex items-center gap-2 hover:text-secondary-600 cursor-pointer transition-all duration-300'>
